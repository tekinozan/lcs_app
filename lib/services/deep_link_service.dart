...
class DeepLinkService {
  ...
  Future<String> createReferLink(String referCode) async {
    final DynamicLinkParameters dynamicLinkParameters = DynamicLinkParameters(
      uriPrefix: 'https://lcsdnm.page.link',
      link: Uri.parse('https://letcoinshop.com//refer?code=$referCode'),
      androidParameters: const AndroidParameters(
        packageName: 'com.example.lcs_app',
        minimumVersion: 1,
      ),
      socialMetaTagParameters: SocialMetaTagParameters(
        title: 'REFER A FRIEND & EARN',
        description: 'Earn 1 LTC on every referral',
